      ...
      <div className={styles.container}>
        <div className={styles.header} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <p className={styles.subtitle}>
            Registration confirmed. Configure your practice workspace to get started.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          {/* Bound verified paid registration intent */}
          <input type="hidden" name="intentId" value={paidIntentId} />
